...
The market shares tell the same story with fewer caveats. In 2015, Dell'Oro put Cisco at [57 percent of data-center Ethernet switch revenue](https://www.prnewswire.com/news-releases/ethernet-switch-market-continues-to-fragment-data-center-drives-growth-according-to-delloro-group-300242991.html), with HPE and Arista tied at 8 percent. The same report forecast that "for each year of the forecast period, the list of mega-Cloud data centers using white-box switches will increase." By 2022, [Omdia had Cisco at 37 percent](https://omdia.tech.informa.com/om024329/data-center-ethernet-switch-market-analysis--2022), Arista at 18, and white-box vendors at 14. The best bookend of all: in 2015 Cisco published a post arguing that [white-box switches were "no bargain"](https://blogs.cisco.com/news/myth-busting-white-box-switches-are-no-bargain) — 20 to 30 percent *more* expensive once support was counted — and by 2026 it was [selling its Silicon One silicon to the white-box builders and SONiC operators](https://hyperframeresearch.com/2026/05/24/ciscos-silicon-one-an-8-12bn-business/). When the incumbent starts arming the commodity ecosystem, the commodity has won.
...
- Dell'Oro Group, [Ethernet Switch Market Continues to Fragment, Data Center Drives Growth](https://www.prnewswire.com/news-releases/ethernet-switch-market-continues-to-fragment-data-center-drives-growth-according-to-delloro-group-300242991.html) (2016)
